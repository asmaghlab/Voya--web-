const HeroSection = ({header, title, dis}: {header?:string ,title:string, dis:string }) => {
  return (
    <section className="relative py-20 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 overflow-hidden rounded-b-[70px]">
      ...
      <div className="container relative">
        <div className="mx-auto max-w-3xl text-center">
          <p
            className="mb-4 animate-fade-up text-sm font-semibold uppercase tracking-widest text-primary"
            style={{ animationDelay: "0ms" }}
          >
            {header ? header : "Explore the World"}
          </p>
